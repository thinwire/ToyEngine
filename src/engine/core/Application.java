...
/**
 * Main engine logic and abstract base class for user applications.
 * 
 * Provides the main loop, sets up graphics and input and provides
 * a display list for rendering Drawables to screen each frame.
 * 
 * To use, extend Application in your class and call the Application
 * constructor like {@code super(800, 600);}, where 800 is your desired
 * output window width and 600 is the height. To run the game, call 
 * the {@code run()} method.
 */
